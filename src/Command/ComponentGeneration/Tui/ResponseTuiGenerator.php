...
class ResponseTuiGenerator extends AbstractTuiComponentGenerator
{
    ...
    private function showComponentList(Tui $tui, callable $onBack): void
    {
        ...
        $container->add(new TextWidget($this->currentOutput->getFormatter()->format("<info>Response — Sélection ou création</info>\n")));
    ...
    private function showForm(Tui $tui, ResponseTuiState $state, callable $onBack): void
    {
        ...
        $container = new ContainerWidget();
        $container->expandVertically(true);
        $container->add(new TextWidget($this->currentOutput->getFormatter()->format("<info>Configuration Response</info>\n")));
